...
namespace Dta.Marketplace.Api.Tests.Controllers.UsersControllerTests {
    public class AuthenticateAsync : IDisposable {
        private DigitalMarketplaceContext _context;
        public AuthenticateAsync() {
            var options = new DbContextOptionsBuilder<DigitalMarketplaceContext>()
                .UseInMemoryDatabase("db")
                .Options;

            _context = new DigitalMarketplaceContext(options);
